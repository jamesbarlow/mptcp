...
investigate more fully, we worked by planning groups of tests which could
...
then rotating them for revision by the other group members. Each section was
rotated and revised many times during the final write up. We used video
calling to discuss changes to the report.
