...
Due to their susceptibility to interference, running experiments on wireless environments proved to be very challenging, giving us a completely different set of results based on when, where and with what equipment we used while testing. These experiments however, gave us a great insight into the behaviour of wireless communications in a real-world setting.
